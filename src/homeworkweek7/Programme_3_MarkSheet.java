...
(marks are between 0 and 100, if it is out of range, print error message "Invalid Input, marks should
between 0 and 100") and find out total, percentage and result.
He is a pass or fail on basis of percentage (pass>=35) and also give them grade if
...
public class Programme_3_MarkSheet {
    ...
    public static void main(String[] args) {
        ...
        printTheMarkSheet (name, rollNum, mathsMarks, scienceMarks, englishMarks, total, percentage,
                result, grade);
